  ...
  return (
    <>
      <li className="flex justify-between items-baseline pb-2  text-text hover:pl-4 hover:text-primary transition-all duration-180">
        <div className=" transition-all duration-200 w-[85%] active:pl-5">
          <div className="border-l-8 border-primary  w-[95%] overflow-hidden truncate bg-background  transition-all duration-180  active:text-primary">
            <button
